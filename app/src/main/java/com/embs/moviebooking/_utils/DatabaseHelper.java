...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void checkTableExist() {
        ...
        String checkTicketTable = "CREATE TABLE IF NOT EXISTS ticket ( uid INTEGER PRIMARY KEY AUTOINCREMENT, userid INTEGER, movieid INTEGER, day TEXT, time TEXT, cinema TEXT, seatnumber INTEGER, purchaseddate TEXT);";
